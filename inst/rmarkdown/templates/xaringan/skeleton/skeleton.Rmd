...
**xaringan** now benefits from **rmarkdown** new Sass support. Suppose you want to use the same color for different elements, e.g first heading and strong text. You can create a `.scss` file, say `mytheme.scss` using the [sass](https://sass-lang.com/) syntax with variables:
...
This is possible since **rmarkdown** 2.8 which will process `.scss` or `.sass` files using the [**sass**](https://rstudio.github.io/sass/) R package. You can learn more about **rmarkdown** and **sass** support in [this blog post](https://blog.rstudio.com/2021/04/15/2021-spring-rmd-news/#sass-and-scss-support-for-html-based-output) and in [**sass** overview vignette](https://rstudio.github.io/sass/articles/sass.html).
