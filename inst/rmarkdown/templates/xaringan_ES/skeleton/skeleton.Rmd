...
translators: "Silvia Canelón, Alejandra Hernandez Segura"
...
Para usar un tema, puedes especificar la opción `css` como un arreglo de archivos CSS (sin las extensiones `.css`). Por ejemplo:
...
El nombre de **xaringan** de este paquete de R se deriva de **Sharingan**<sup>1</sup>, un dōjutsu en el anime japonés _Naruto_ que tiene dos habilidades:
...
.footnote[
[1] En chino, la pronunciación de _X_ es _Sh_ /ʃ/ (como en _shrimp_). Ahora deberías tener una mejor idea de cómo pronunciar mi apellido: _Xie_.

[2] En comparación, una mala presentación sólo pone a la audiencia a dormir.

[3] Personalmente, me parece que usar imágenes de fondo para una diapositiva es una característica muy importante de remark.js. Es una manera efectiva de crear un impacto visual en tus presentaciones.
]
...
- The [summoning technique (Jutsu de Invocación)](https://naruto.fandom.com/es/wiki/Jutsu_de_Invocaci%C3%B3n) (bajar remark.js de la web)
